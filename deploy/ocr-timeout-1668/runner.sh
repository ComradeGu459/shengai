...
[ "$inbound" = '/var/tmp/qimao-ocr-timeout-1668-inbound' ] \
  || input_fail 'INBOUND_PATH_INVALID'

archive_name='ocr-timeout-20260831-r1.tar.gz'
...
lock_file='/run/lock/qimao-ocr-timeout-1668.lock'
exec 9>"$lock_file"
flock -n 9 || input_fail 'LOCK_ALREADY_HELD'

old_release='/opt/qimao-terms-cloud/releases/asr-srt-compare-20260831-r2'
new_release='/opt/qimao-terms-cloud/releases/ocr-timeout-20260831-r1'
release_stage='/opt/qimao-terms-cloud/releases/.ocr-timeout-20260831-r1-stage-1668'
current='/opt/qimao-terms-cloud/current'
current_next='/opt/qimao-terms-cloud/current.ocr-timeout-1668.next'
static_link='/srv/qimao-terms-cloud/frontend'
old_static='/srv/qimao-terms-cloud/frontend-asr-srt-compare-20260831-r2'
runtime='/run/qimao-ocr-timeout-1668'
...
echo "baseline=passed current:r2 backend:$old_backend_state asr:$old_asr_state screen:$old_screen_state openvino:$old_openvino_state timeouts:60000/60000"
...
echo 'candidate_import_gate=passed qimao:imports+timeouts(60000/61000/62000)'
...
health_wait
sidecar_contract
echo "post_switch=passed backend:$candidate_backend_state/stable_pid_5s openvino:active/running/norestart_delta screen:$old_screen_state asr:$old_asr_state HTTP:200/200"
...
safe_remove "$runtime"
trap - ERR EXIT INT TERM
echo "terminal=passed current:$new_release backend_restart:1 openvino_restart:0 timeouts:60000/61000/62000 asr_restart:0 screen_start:0 db_write:0 cos_write:0 route_write:0 budget_write:0 provider_calls:0"
exit 0
