...
archive_name='asr-srt-compare-20260831-r2.tar.gz'
...
lock_file='/run/lock/qimao-asr-srt-compare-1642.lock'
exec 9>"$lock_file"
flock -n 9 || input_fail 'LOCK_ALREADY_HELD'

old_release='/opt/qimao-terms-cloud/releases/ai-recovery-1607-r3'
new_release='/opt/qimao-terms-cloud/releases/asr-srt-compare-20260831-r2'
release_stage='/opt/qimao-terms-cloud/releases/.asr-srt-compare-20260831-r2-stage-1642'
current='/opt/qimao-terms-cloud/current'
current_next='/opt/qimao-terms-cloud/current.asr-srt-compare-20260831-r2.next'
old_static='/srv/qimao-terms-cloud/frontend-ai-hotfix-1552'
new_static='/srv/qimao-terms-cloud/frontend-asr-srt-compare-20260831-r2'
static_stage='/srv/qimao-terms-cloud/.frontend-asr-srt-compare-20260831-r2-stage-1642'
static_link='/srv/qimao-terms-cloud/frontend'
static_next='/srv/qimao-terms-cloud/frontend.asr-srt-compare-20260831-r2.next'
runtime='/run/qimao-asr-srt-compare-1642'
...
rollback() {
  ...
  if [ "$backend_restart_attempted" -eq 1 ] || [ "$backend_switched" -eq 1 ]; then
...
grep -R -F -q -- '查看 SRT 对照' "$static_stage/assets"
grep -R -F -q -- '抽样集：第 2 / 8 / 29 集' "$static_stage/assets"
echo 'candidate_gate=passed backend_entries:5 static:index+assets+markers'
...
api_result="$(curl --silent --show-error --max-time 10 \
  ...
  http://127.0.0.1:3001/api/projects/00000000-0000-0000-0000-000000000000/asr/batches/00000000-0000-0000-0000-000000000000/srt-compare)"
...
[ "$(curl --silent --show-error --max-time 5 -o /dev/null -w '%{http_code}' http://127.0.0.1:8080/ 2>/dev/null || true)" = '200' ]
[ "$(curl --silent --show-error --max-time 5 -o /dev/null -w '%{http_code}' http://127.0.0.1:8080/projects/1/asr 2>/dev/null || true)" = '200' ]
echo "post_switch=passed health:200 unauth_compare:401/json/nonhtml employee:200/200 backend:$candidate_backend_state/stable_pid_5s asr:$old_asr_state screen:$old_screen_state ocr:$old_ocr_state"
...
trap - ERR EXIT INT TERM
echo "terminal=passed candidate:$new_release static:$new_static backend_restart:1 db_write:0 cos_write:0 route_write:0 budget_write:0 provider_calls:0 asr_restart:0 ocr_restart:0 screen_start:0"
exit 0
